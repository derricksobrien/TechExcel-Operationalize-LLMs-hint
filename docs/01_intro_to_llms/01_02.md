...
1. Using [Azure AI Studio](https://ai.azure.com), deploy the `Phi-3.5-mini-instruct` model from the catalog using Serverless API.
...
HINT: you may need to select the right model once you enter the Playground 
