...
1. Open the terminal and perform the following steps:
    ...
    1. Initialize the environment variables with your development environment values:
       ...
       {: .important }
       > You can check the list of environment variables if you expand the .azure folder and find the .env file.  You can copy this file over to the .env file based on .env.template
