...
1. Finally, execute the script to load the documents into AI Search:
       ...
       {: .important }
       > If you encounter any errors in provisioning the script will indicate.
       > Your goal is to have all stages in the script to be completed without errors and for the index to be rebuilt
